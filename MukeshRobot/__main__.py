    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            x=update.effective_message.reply_sticker(
                "CAACAgQAAxkBAAIE0GRPN-fzUlFspG-Layp4jLEnxrxaAAI3EAACVPXgUUl5iN8_fBx1LwQ")
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="🥀sᴏᴜʀᴄᴇ🥀",
                            url="https://github.com/afzal0006/mukeshRobot",
                        ),
                    ],
                    [
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="🥀ᴜᴩᴅᴀᴛᴇs🥀", url=f"https://t.me/theupdatechannel_143"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="🥀ɢɪᴛʜᴜʙ🥀", url="https://te.legra.ph/file/811a37f6b25b86bbc7c33.jpg"
                        ),
                    ],
                    [
...
""",
        ...
        query.message.edit_text(text=f"*» ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ «*"
            f"""
 ᴀᴅᴅ *ᴄ* ɪɴ ᴛʜᴇ sᴛᴀʀᴛɪɴɢ ᴏғ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅs ᴛᴏ ᴜsᴇ ᴛʜᴇᴍ ғᴏʀ ᴄʜᴀɴɴᴇʟ.
